        ...
        <div className="group" id="card-color">
            <div className="aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-3xl bg-gray-200 xl:aspect-w-7 xl:aspect-h-8">
                <ReactCardFlip isFlipped={isFlipped}>
                    <img src ={backFace} alt ='back face card' className="h-30 w-30 group-hover:opacity-75 rounded-3xl" onClick = {handleClick}/>
                    <img key={key} src = {image} alt ={name} className="h-30 w-30 group-hover:opacity-75 rounded-3xl"/>
                </ReactCardFlip>
            </div>
        </div>
    </>
